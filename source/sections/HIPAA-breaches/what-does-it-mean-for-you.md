...
- Turn in your keys and your laptop to your supervisor or HR when you leave NutriAdmin.
...
- Do not use dictionary words (e.g., NutriAdmin, password123).
...
- Store confidential information such as PHI only on NutriAdmin's secured network servers. Never store PHI on a laptop or other portable, endpoint device.
...
**Violating NutriAdmin policies, federal regulations, and state laws and regulations can lead to disciplinary action – up to and including termination, personal fines, civil and criminal penalties and suspension of professional licenses.**
